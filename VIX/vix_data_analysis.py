...
def hist_average_std_dev (data):
    hist_std_dev =[]
    for row in data:
        hist_std_dev = (data['CLOSE'].rolling(30).std())
        for i in range(30):
            del hist_std_dev[i]
...
print('The average historical 30 day vix std dev is:    ', hist_average_std_dev(data))
print('Current VIX price: ',  vix_current()[0], '       Past 30 day avg std dev: ', vix_current()[1])
